...
async def welcome(message: Message):
    ...
    await message.answer(
        "Добро пожаловать! Поделитесь геолокацией, чтобы мы могли найти ближайшие мероприятия не только по времени, но и по месту. Чтобы найти ближайшие по времени мероприятия - /events",
