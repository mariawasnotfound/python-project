...
async def welcome(message: Message):
    ...
    await message.answer(
        "Добро пожаловать! Поделитесь геолокацией, чтобы мы могли найти ближайшие мероприятия не только по времени, но и по месту. Найти ближайшие по времени мероприятия: /events",
